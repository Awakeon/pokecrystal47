...
BugsyGroup:
	...
	db 16
	dw BEEDRILL
	dw POISON_STING, STRING_SHOT, BUG_BITE, NO_MOVE
	db 16
	dw KABUTO
	dw ROCK_THROW, AQUA_CUTTER, BUG_BITE, NO_MOVE
	db 18
	dw SCYTHER
...
SageGroup:
	...
	db 13
	dw GASTLY
	dw SHADOW_BALL, MEGA_DRAIN, NO_MOVE, NO_MOVE
	db 13
	dw BELLSPROUT
	dw WRAP, MEGA_DRAIN, SLUDGE, NO_MOVE, NO_MOVE
	db 14
	dw VULPIX
	dw EMBER, NIGHT_SHADE, BITE, NO_MOVE, NO_MOVE
	db 15
	dw NOCTOWL 
	dw NIGHT_SHADE, WING_ATTACK, HEADBUTT, NO_MOVE
	db -1 ; end
	...
	db 15
	dw EEVEE
	dw HEADBUTT, DOUBLE_KICK, BITE, NO_MOVE
	db 15
	dw PIKACHU
	dw SPARM, THUNDER_WAVE, SEISMIC_TOSS, NO_MOVE
	db 16
	dw VULPIX
	dw EMBER, NIGHT_SHADE, CONFUSION, NO_MOVE
	db 17
	dw NOCTOWL 
	dw NIGHT_SHADE, WING_ATTACK, HEADBUTT, NO_MOVE
	db -1 ; end
